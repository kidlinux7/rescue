  ...
  async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`
        CREATE or REPLACE VIEW "oky_en".answered_surveys
            AS
            SELECT payload ->> 'id' as id, payload ->> 'questions' as question,payload ->> 'answerID' as answerID, payload ->> 'answer' as answer, payload ->> 'utcDateTime' as date, payload ->> 'isCompleted' as isCompleted,  payload ->> 'isSurveyAnswered' as isSurveyAnswered, payload ->> 'userID' as user_id, payload ->> 'questions' as questions
            FROM oky_en.app_event
