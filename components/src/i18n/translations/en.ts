export const en = {
  ...
  birth_year_info_heading: `Birth year`,
  ...
  name_info_label:
    'Info button for your Oky username. The name you will use to sign in to Oky. Minimum 3 characters',
  correct: `That's correct!`,
  not_correct: `Oops, that one wasn't quite right. No need to worry, you will get the next one`,
  profile: 'your profile',
  profile_edit: 'edit profile',
  passcode_description: 'Choose a passcode to keep your Oky account private!',
  ...
  village: 'village',
  zanzibar: 'zanzibar',
  lang_select: 'choose region',
  penal_code_text1:
    'Please confirm your country or location, to help us determine what language your app will be in.',
  ...
  heavy: 'heavy',
  spotting: 'spotting',
  start_new: 'Started New Period',
  no_day: 'No',

  // ------------------------- Notifications ----------------------------
  notification_1_title: 'How was your week?',
  notification_1_body: `Don't forget to fill in your Daily Diaries and learn more about your body and mood!`,
  notification_2_title: 'Your Oky buddy misses you! ',
  notification_2_body: 'By using your Daily Diary every day, Oky can make better predictions 🤓',
  notification_3_title: 'Did you know?',
  notification_3_body: 'You can use Oky to become a boss when it comes to facts about your body! ',
  notification_4_title: 'Time for a fresh start!',
  notification_4_body: 'Use your Daily Diary from today 🤳 to predict your next month!',
  notification_5_title: 'Hello stranger!',
  notification_5_body:
    'I am still here whenever you are ready to start your journey to knowing YOU better!🤝',
  notification_6_title: 'Do you know the answer?',
  notification_6_body:
    'Is it true that cold food gives you cramps?😳 Find out the answer in the Oky encyclopedia!',
  ...
  continue: 'continue',
  welcome_heading: `Welcome to Oky!`,
  i_agree: 'I agree',
  ...
  share_setting: 'Share',
  language: 'Language',
  choose_language: 'Change the language Oky uses:',
  ...
  location: 'location',
  location_subtitle: 'Share your location',
  ...
  password_request_info: 'Ask for your passcode every time you open the app',
  ...
  journey_heading: 'Track your period',
  ...
  safe_word: 'answer to secret question',
  alert: 'Save account',
  ...
  logout_account_description:
    'As a guest user, all the information you gave Oky will not be saved when you log out.\n\nTap Save Account in your profile to save it now!',
  ...
  contact_name_1: 'Name 1',
  contact_address_1: 'Unknown Address 1',
  contact_phone_number_1: '+00 0000000',
  contact_website_1: 'Unknown website 1',

  contact_name_2: 'Name 2',
  contact_address_2: 'Unknown Address 2',
  ...
  change: 'change',
  survey_option_unit_day: 'day',
  survey_option_unit_days: 'days',
  survey_option_unit_week: 'week',
  survey_option_unit_weeks: 'weeks',
  yes: 'yes',
  no: 'no',
  Yes: 'Yes',
  No: 'No',
  ...
  name_error_content: 'The name you will use to sign in to Oky. Minimum 3 characters.',
  ...
  password_confirm_error_heading: 'Passcode requirements',
  password_confirm_error_content:
    'The passcode confirm field requires a minimum of 4 characters and to match the passcode field.',
  login_name_error_heading: 'Login name requirements',
  login_name_error_content:
    'The name field requires a minimum of 3 characters and to match the registered user',
  login_password_error_heading: 'Passcode requirements',
  login_password_error_content: 'The passcode needs to match the registered passcode.',
  request_error:
  ...
  login_failed: 'Invalid request',
  password_incorrect: 'Passcode incorrect',
  penal_code_warning: `If you are changing to Bahasa, you won't be able to change back.`,
  penal_code_restriction: 'Language change restricted',
  ...
  could_not_edit: 'Could not edit user information',
  could_not_change_password: 'Could not change passcode',
  ...
  daily_notes_content: `Your page to let off steam, daydream, or write whatever you like about your day!`,
