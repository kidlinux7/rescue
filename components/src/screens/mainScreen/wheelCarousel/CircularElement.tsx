...
export function CircularElement({
  ...
  const margin = themeName === 'zanzibar' ? 0 : 10 // No margin for the continuos circle
  ...
  const cloudAdjust = themeName !== 'shule' && themeName !== 'zanzibar' ? { left: -3 } : null
    ...
    >
      <Animated.View
        ...
        style={{
          ...
          transform: [
            {
              scale: themeName === 'zanzibar' ? 1 : scale,
              rotateZ:
                themeName === 'zanzibar'
                  ? '-0.2deg'
      ...
      >
        ...
        >
          <ImageBackground
            style={{
              width: themeName === 'zanzibar' ? 0.15 * heightOfScreen : 70,
              height: themeName === 'zanzibar' ? 0.15 * heightOfScreen : 70,
              alignItems: 'center',
              justifyContent: 'center',
            }}
            resizeMode="contain"
